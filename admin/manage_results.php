<?php 
    ...
    include 'manage_results_functions.php';
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="main-page" style="background-color: white;">
                    <div class="container-fluid">
                        <div class="row page-title-div"
                            ...
                            <div>
                                <h2 class="title" style="color: white; font-size: 20px;"><b>Manage Results</b></h2>
                            </div>
                        </div>
                    </div>
                    <section class="section">
                        <h4 style="padding-top: 30px; padding-bottom: 20px; padding-left: 10%; color: black;"><b>Manage Students' Results -</b></h4><br>
                        <div class="container-fluid">
                            <div class="row">
