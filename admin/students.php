                                                    ...
                                                    if (mysqli_num_rows($result) == 0) {
                                                        ...
                                                        while ($book_row = mysqli_fetch_assoc($result)) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th>
                                                                    <?php echo htmlentities($book_row["roll_id"]); ?>
                                                                </th>
                                                                <th>
                                                                    <?php echo htmlentities($book_row["course_name"]); ?>
                                                                </th>
                                                                <th>
                                                                    <?php echo htmlentities($book_row["semester"]); ?>
                                                                </th>
                                                                <th><a href="update_student.php?std=<?php echo htmlentities($book_row["id"]); ?>"><i class="fa fa-edit" title="Edit Record"></i></a></th>
                                                            <?php
                                                        }
                                                    }
                                                    ?>
